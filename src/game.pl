...
update_enemy_position(N) :- enemy(N,Absis,Ordinat,Enemy_Weapon), random(1,5,Random), peta(M), element_matriks(M,Absis,Ordinat,CEnemy),
                            (CEnemy \= 'X' ->
                                (Random = 1 -> %musuh keatas
                                    ...
                                    (C \= 'X' ->
                                        ...
                                        %updaete enemy
                                        retract(enemy(N,Absis,Ordinat,Enemy_Weapon)),
                                        asserta(enemy(N,Absis1,Ordinat,Enemy_Weapon))
                                    ;
                                        write('')
                                    )
                                ...
                                ; Random = 3 -> %musuh ke kiri
                                    ...
                                    (C \= 'X' ->
                                        ...
                                        %update enemy
                                        retract(enemy(N,Absis,Ordinat,Enemy_Weapon)),
                                        asserta(enemy(N,Absis,Ordinat1,Enemy_Weapon))
                                    ;
                                        write('')
                                    )
                                ; Random = 4 ->
...
update_count_enemy(N) :- enemy(N,Absis,Ordinat,_), peta(M), element_matriks(M,Absis,Ordinat,C), count_enemy(N_enemy),
                        (C = 'X' ->
